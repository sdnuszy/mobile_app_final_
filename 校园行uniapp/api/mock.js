/* src/api/mock.js  必须被 main.js 引入  */
import Mock from 'mockjs'

// 1. 首页 banner
Mock.mock('https://apifoxmock.com/m1/4728220-0-default/api/user/getBanner', 'get', {
  code: 1,
  data: {
    bannerList: [
      {
...
// 2. 首页列表
Mock.mock('https://apifoxmock.com/m1/4728220-0-default/api/user/getHomeList', 'get', {
  code: 1,
  data: [
    {
      id: 1,
